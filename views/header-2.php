            ...
            <?php } else { ?>
             <div  class="navMenu text-white d-flex justify-content-center" style="align-items: center; margin-left: auto;">
				...
				<div class="userInfo d-flex align-items-center justify-content-center" tabindex="0" role="button" data-bs-html="true" data-bs-toggle="popover" title="<div class='userInfoText'>Welcome,<br /><?php if (isset($_SESSION['user_name'])) {
																																																				...
																																																				} ?></div>" data-bs-content="<div class='d-block userInfoItem'>To Overview</div><a class='d-block userInfoItem' href='?function=mysettingpage'>My Settings</a><a class='d-block userInfoItem text-decoration-none' href='?function=logout'>Logout</a>">
