...
<body>
    ...
    <div class="navMenu collapsed text-white d-flex align-items-start align-items-md-center justify-content-center">
      ...
      <div class="loggedInMenu d-flex align-items-center justify-content-center">
        ...
        <div class="userInfo d-flex align-items-center justify-content-center" tabindex="0" role="button" data-bs-html="true" data-bs-toggle="popover" title="<div class='userInfoText'>Welcome,<br /><?php if (isset($_SESSION['user_name'])) {
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      } ?></div>" data-bs-content="<div class='d-block userInfoItem'>My Dashboard</div><a class='d-block userInfoItem text-decoration-none' href='?function=mysettingpage'>My Settings</a><a class='d-block userInfoItem text-decoration-none' href='?function=logout'>Logout</a>">
  ...
  <nav class="navSm d-flex d-md-none align-items-center justify-content-between">
    ...
    <div class="fullPage d-flex">
      ...
      <div class="navSmMenu bg-white">
        ...
        <div class="navSmMenuItem active">Service History</div>
        <div class="navSmMenuItem">Service Schedule</div>
        <div class="navSmMenuItem">Favourite Providers</div>
        <div class="navSmMenuItem">Invoices</div>
        <div class="navSmMenuItem">Notifications</div>
        <div class="navSmMenuItem" id="Mysetting">My Settings</div>
  ...
  <div class="container position-relative d-flex align-items-start justify-content-center">
    ...
    <div class="serviceHistoryTableContainer" id="demo">
      ...
      <form style="color:#646464 ; font-weight: bold;" id="tab1">
        <div class="form m-3">
          <div class="row mb-3">
            <div class="col-4">
          ...
          <button type="button" style="background-color: #1D7A8C;" class="btn rounded-pill text-white">Save</button>
        </div>
      </form>

      <div id="tab3">
        <form style="color:#646464 ; font-weight: bold;">
          <div class="form m-3">
            <div class="row mb-3">
              <div class="col-4">
            ...
            <div class="row mb-3">
              <div class="col-4">
                ...
                <input type="password" class="form-control" id="inputEmail4" placeholder="Repeat Password">
              </div>
            </div>


          </div>
          <button type="button" style="background-color: #1D7A8C; margin-left:18px" class="btn rounded-pill text-white">Save</button>
        </form>
    ...
    <table class="table text-center">
      ...
      <tbody>
        <tr>
          <th scope="row"> <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1"></th>
          <td>Mark</td>
          <td>Otto</td>
